...
import {Event, IEvent} from '../Event.js';
...
describe('Event Model', () => {
    ...
    it('should correctly reference the User model', async () => {
        ...
        expect((foundEvent!.creator as IUser).name).toBe(testUser.name);
        expect((foundEvent!.creator as IUser).email).toBe(testUser.email);
    });
});
