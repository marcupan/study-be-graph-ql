  ...
  describe('Query', () => {
    describe('events', () => {
      ...
      it('should handle errors', async () => {
        ...
        // Act & Assert
        await expect(eventResolvers.Query.events(null, {}, {} as any))
    ...
    describe('eventsByDate', () => {
      it('should return events for a specific date', async () => {
        ...
        // Act
        const result = await eventResolvers.Query.eventsByDate(null, { date }, {} as any);
    ...
    describe('myEvents', () => {
      it('should return events created by the authenticated user', async () => {
        ...
        // Act
        const result = await eventResolvers.Query.myEvents(null, {}, mockContext as any);
  ...
  describe('Event', () => {
    describe('creator', () => {
      it('should return the creator of the event', async () => {
        ...
        // Act
        const result = await eventResolvers.Event.creator(parent as any, {}, mockContext as any);
    ...
    describe('attendees', () => {
      it('should return the attendees of the event', async () => {
        ...
        // Act
        const result = await eventResolvers.Event.attendees(parent as any, {}, mockContext as any);
