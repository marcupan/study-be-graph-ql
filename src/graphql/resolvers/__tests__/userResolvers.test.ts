  ...
  describe('Query', () => {
    describe('users', () => {
      it('should return paginated users', async () => {
        ...
        // Act
        const result = await userResolvers.Query.users(null, {}, {} as any);
      ...
      it('should handle errors', async () => {
        ...
        // Act & Assert
        await expect(userResolvers.Query.users(null, {}, {} as any))
    ...
    describe('me', () => {
      it('should return the authenticated user', async () => {
        ...
        // Act
        const result = await userResolvers.Query.me(null, {}, mockContext as any);
